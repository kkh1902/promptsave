            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground max-w-3xl">
                  Discover amazing AI-generated videos created by our community. From short clips to full animations,
                  explore the creative possibilities of AI video generation.
                </p>
              </div>
