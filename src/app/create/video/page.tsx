...
import { ArrowLeft, Video, Info, Plus } from "lucide-react"
...
export default function CreateVideoPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navigation />
      <CategoryNavigation type="video" selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 space-y-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-2">
                <li>• Add a clear title that describes your video</li>
                <li>• Include the prompt used to generate the video</li>
