            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground max-w-3xl">
                  Explore the latest discussions, tutorials, and insights from our community. Learn new techniques,
                  share your experiences, and connect with other AI art enthusiasts.
                </p>
              </div>
