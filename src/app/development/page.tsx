            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground max-w-3xl">
                  Explore the latest tools, scripts, and plugins for AI art generation. Contribute to open-source projects,
                  share your code, and help improve the AI art ecosystem.
                </p>
              </div>
