            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground max-w-3xl">
                  Explore a vast collection of AI-generated images created by our community. Find inspiration, discover new
                  styles, and see what's possible with AI art generation.
                </p>
              </div>
